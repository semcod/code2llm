...
def _extract_functions_ts(
    tree, source_bytes: bytes, lang: str, module_name: str, file_path: str
...
def extract_declarations_ts(
    ...
    return {
        "module": ModuleInfo(
            name=module_name,
            file=file_path,
            is_package=Path(file_path).name
            in ("__init__.py", "index.js", "index.ts", "mod.rs", "lib.rs"),
        ),
        "functions": functions,
        "classes": classes,
        "nodes": {},
